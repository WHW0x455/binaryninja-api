...
use binaryninjacore_sys::{
    ...
    BNPossibleValueSetAdd, BNPossibleValueSetAnd, BNPossibleValueSetArithShiftRight,
    BNPossibleValueSetIntersection, BNPossibleValueSetLogicalShiftRight,
    BNPossibleValueSetMultiply, BNPossibleValueSetNegate, BNPossibleValueSetNot,
    BNPossibleValueSetOr, BNPossibleValueSetRotateLeft, BNPossibleValueSetRotateRight,
    BNPossibleValueSetShiftLeft, BNPossibleValueSetSignedDivide, BNPossibleValueSetSignedMod,
    BNPossibleValueSetSubtract, BNPossibleValueSetUnion, BNPossibleValueSetUnsignedDivide,
    BNPossibleValueSetUnsignedMod, BNPossibleValueSetXor, BNRegisterValue, BNRegisterValueType,
    BNStackVariableReference, BNToVariableIdentifier, BNTypeWithConfidence, BNUserVariableValue,
    BNValueRange, BNVariable, BNVariableNameAndType, BNVariableSourceType,
};
