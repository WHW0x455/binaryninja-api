...
pub struct BinaryNinjaLayer {
    ...
    /// than only when a target is omitted.
    ///
    /// # Example
    ///
...
impl BinaryNinjaLayer {
    ...
    pub fn with_formatted_target(mut self, formatted: bool) -> Self {
        self.formatted_target = formatted;
        self
    }
}
